#Problem Statement: Build an analytical model to create clusters of airline travellers using Hierarchical and K-means clustering,
#so that it helps the airline to learn more about its customers and target different customer segments with different types of mileage offers.
...
Path<-setwd("E:/IVY PRO SCHOOL/R/05 PREDICTIVE ANALYTICS PROJECTS/02 CLUSTERING/CASE STUDY1/02DATA")
